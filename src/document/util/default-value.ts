...
import { DocumentPropertyValueObject, IMBRICATE_PROPERTY_TYPE } from "@imbricate/core";

// IMBRICATE_PROPERTY_TYPE SWITCH
export const getDefaultValueOfProperty = (type: IMBRICATE_PROPERTY_TYPE): DocumentPropertyValueObject<IMBRICATE_PROPERTY_TYPE> => {
