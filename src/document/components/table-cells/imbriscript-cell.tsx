...
export type DocumentTableImbriscriptCellProps = {
    ...
    readonly getEditingProperty: () => DocumentPropertyValueObject<IMBRICATE_PROPERTY_TYPE.IMBRISCRIPT> | undefined;
    readonly updateEditingProperty: (value: DocumentPropertyValueObject<IMBRICATE_PROPERTY_TYPE.IMBRISCRIPT>) => void;
    readonly editing: boolean;
};

export const DocumentTableImbriscriptCell: FC<DocumentTableImbriscriptCellProps> = (
    props: DocumentTableImbriscriptCellProps,
) => {
    ...
    if (props.editing) {
        ...
        >
            ...
            >
                ...
                <PopoverContent>
                    ImbriScript property is not editable, please edit the ImbriScript file directly after saving the document.
                </PopoverContent>
            </Popover>
        </div>);
    }
    ...
    return (<DocumentTableCellContent
        schemaType={IMBRICATE_PROPERTY_TYPE.IMBRISCRIPT}
